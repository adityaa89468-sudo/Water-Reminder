import{V as m,_ as y,X as T,Y as P,Z as ee,$ as M,a0 as _e,a1 as Ne,a2 as Ce,a3 as De,a4 as I,a5 as Oe,a6 as A,W as Re}from"./index-C4PxAlV5.js";const te="@firebase/installations",F="0.6.21";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Xt(e,t){const n=t.data;if(!n.isFirebaseMessaging)return;e.onMessageHandler&&n.messageType===b.PUSH_RECEIVED&&(typeof e.onMessageHandler=="function"?e.onMessageHandler(X(n)):e.onMessageHandler.next(X(n)));const i=n.data;Bt(i)&&i[vt]==="1"&&await Yt(e,n.messageType,i)}const Q="@firebase/messaging",Z="0.12.25";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
